/* this file was taken from sliding-window-aggregators (https://github.com/IBM/sliding-window-aggregators) */
...
template <typename I, typename P, typename O>
const typename Min<I,P,O>::Partial Min<I,P,O>::identity = P();

template <>
const typename Min<int>::Partial Min<int>::identity = std::numeric_limits<int>::max();
